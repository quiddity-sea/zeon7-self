                    ...
                    <div class="deck-panel">
                        ...
                        <div id="view-produce" class="controls active">
                            ...
                            <div id="generatedContent" style="display:none; margin-top:2rem;">
                                <div class="section-head" style="font-size:0.8rem; color:var(--cyan); margin-bottom:1rem;">GENERATED SUITE</div>
                        ...
                        <div id="view-brain" class="controls">
                            <div class="widget">
                                ...
                                <div class="dropzone" id="brainDropzone">DRAG KNOWLEDGE FILES HERE</div>
                        ...
                        <div id="view-memory" class="controls">
                            <div class="widget">
                                ...
                                <div id="memoryLogContainer" style="color: var(--text-muted); font-style: italic;">No active lore entries.</div>
                            </div>
                        </div>
                    </div>
                </div>
